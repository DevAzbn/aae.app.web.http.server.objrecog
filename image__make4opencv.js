...
azbn.mdl('fs/tree').walk('./data/opencv/education/process/negatives/' + argv.type, function(file, stat){
	...
	app.saveFile('opencv/education/process/negatives/' + argv.type + '.txt', files__negative.join('\n'));
	...
	app.saveFile('opencv/education/process/' + argv.type + (is_windows ? '.bat' : '.sh'), cmd__result.join('\n'));
